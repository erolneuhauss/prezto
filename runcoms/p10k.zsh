# Generated by Powerlevel10k configuration wizard on 2024-09-13 at 11:15 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='manage*|deploy.sh|cilium|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
