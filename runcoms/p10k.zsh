# Generated by Powerlevel10k configuration wizard on 2021-10-18 at 12:55 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='manage*|deploy.sh|cilium|flux|kubectl|helm|kubens|kubectx|oc|popeye|istioctl|kogito|k9s|helmfile|stern|kpoof'
  ...
  #
    ...
    typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
        ...
        '*next-prod*'  PROD    # These values are examples that are unlikely
        '*next-stage*' STAGE
        '*'       DEFAULT)
